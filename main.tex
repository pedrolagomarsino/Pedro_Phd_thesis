...
\usepackage[natbib=true,maxbibnames=99,firstinits=true,citestyle=authoryear]{biblatex}
...
\thesistitle{Interplay between astrocytic and neuronal networks during virtual navigation in the mouse hippocampus}
...
\bsuniversity{U.B.A}
\msuniversity{Universidad de Buenos Aires}
